...
**Java 内存可以粗糙的区分为堆内存（Heap）和栈内存 (Stack)，其中栈就是现在说的虚拟机栈，或者说是虚拟机栈中局部变量表部分。** （实际上，Java 虚拟机栈是由一个个栈帧组成，而每个栈帧中都拥有：**局部变量表、操作数栈、动态链接、方法出口**信息。）
...
- https://www.jianshu.com/p/8be816cbb5ed TLAB简书介绍
...
https://blog.csdn.net/lkforce/article/details/81128115 java对象头和对象组成
